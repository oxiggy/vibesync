		...
		<div className="flex gap-4 flex-col">
			<div className="flex gap-4 items-start justify-between">
				<div className="grow flex gap-2 flex-col">
					<InputWithLang placeholder="Название игры" className="!text-lg font-bold" lang="ru" value={gameName.ru} onChange={(e: React.ChangeEvent<HTMLInputElement>) => setGameName((g) => ({ ...g, ru: e.target.value }))} />
					<InputWithLang placeholder="Game name" className="!text-lg font-bold" lang="en" value={gameName.en} onChange={(e: React.ChangeEvent<HTMLInputElement>) => setGameName((g) => ({ ...g, en: e.target.value }))} />
				</div>
					...
					<div className="grow flex gap-3 flex-col">
						<div className="flex gap-2 flex-col">
							<InputWithLang
								...
								onChange={(e: React.ChangeEvent<HTMLInputElement>) => handleQuestionTitleChange(qIdx, 'ru', e.target.value)}
							/>
							<InputWithLang
								...
								onChange={(e: React.ChangeEvent<HTMLInputElement>) => handleQuestionTitleChange(qIdx, 'en', e.target.value)}
							/>
						</div>
					</div>
